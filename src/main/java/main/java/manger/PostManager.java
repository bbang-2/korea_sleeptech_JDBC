        ...
        while (true) {
            ...
            switch (menu) {
                case 1:
                    ...
                    boolean sucess = service.writePost(title, content, author);
                    System.out.println(sucess ? "게시글 등록 완료!" : "유효성 검사를 통과하지 못했습니다.");
                    break;
                case 2:
                ...
                case 4:
                    ...
                    System.out.println(updated ? "수정 완료" : "유효성 검사 실패 or 게시글 없음");
                    break;
                case 5:
